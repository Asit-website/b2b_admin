...
function ViewSubscription() {
    const { setUser, getSubscription,deleteSubscription } = useMain();
    ...
    const getData = async () => {
        const ans = await getSubscription();
        setSubscription(ans.data);
        console.log(ans.data)
    }

    const deleteSubscription1 = async (id) => {
        confirmAlert({
        ...
        <div className="w-full min-h-[100vh] bg-[#111827]">
            ...
            <div class="p-4 sm:ml-64  min-h-[100vh]">
                <div className="mt-6 hj">
                    ...
                    <div className="flex ui flex-wrap items-center">
                        {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <p className="font-normal text-gray-700 dark:text-gray-400">
                                            Subscription_price: {e.subsciption_price}
                                        </p>
                                        <p className="font-normal text-gray-700 dark:text-gray-400">
                                            {e.desc1}
                                        </p>
                                        ...
                                        <div className="trsh mt-4">
                                           <span className="cursor-pointer" onClick={()=>{
                                               navigate(`/createSubs` , { state: { e } })
                                           }}>Edit</span>
                                           <span className="cursor-pointer" onClick={()=>{
                                              deleteSubscription1(e._id)
                                           }}>Delete</span>
                                        </div>
                                    </a>
                                )
