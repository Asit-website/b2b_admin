...
function Dashboard() {
   ...
   const { getUsers, getProjects1, setUser,getSubscription } = useMain();
   ...
   const getData = async () => {
      ...
      const ans1 = await getProjects1('', '', '', '');
      const ans2 = await getSubscription();
      // const ans2 = await getUserBuilders('','','','');
      // console.log(ans);
      setUsers(ans.data);
      setProjects(ans1.data);
      setSubscription(ans2.data);
      // setUserProject(ans2.data);
   };
   ...
   return (
      <div className="w-full min-h-[100vh] bg-[#111827]">
         ...
         <div class="p-4 sm:ml-64  min-h-[100vh]">
            ...
            <div className="singing flex items-center justify-center">
               ...
               <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                  ...
                  <p class="font-normal text-gray-700 dark:text-gray-400">{users?.length}</p>
               </a>
               <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Total Products</h5>
                  <p class="font-normal text-gray-700 dark:text-gray-400">{projects.length}</p>
               </a>

               <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Total Subscription</h5>
                  <p class="font-normal text-gray-700 dark:text-gray-400">{subscription.length}</p>
               </a>
